...
import OrderDetailsPanel from "./OrderDetailPanel";
import CustomerCallHistory from "./CustomerCallHistory";
import CustomerSearchBox from "./CustomerSearchBox";
import CustomerManualEntry from "./CustomerManualEntry";
...
const searchCustomerAPI = async (searchTerm) => {
  ...
  const handleSubmit = async (formSubmissionData) => {
    try {
      const submissionData = {
        ...
        customerNumber: from === "contacts-directory" ? searchTermNumber : currentPhoneNumber,
      };
  ...
  const fromContactDirectory = from === "contacts-directory";
  ...
  const shouldShowPage =
    ...
    hasUnsavedChanges() ||
    mustCompleteForm ||
    formCompletionRequired || fromContactDirectory ;
          ...
          <div className="max-w-[680px] mx-auto h-full">
            <div className="bg-white rounded-lg shadow border border-gray-200 h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto">
                {!isFormOpen && !isCallActive() && hasUnsavedChanges() ? (
